...
#imtahan word file'da vif'e 5 qoy
...
# Splitting the data ----
#imtahan ucun notlarda 80/20 bol
h2o_data <- h2o_data %>% h2o.splitFrame(ratios = 0.9, seed = 123)
train <- h2o_data[[1]]
test <- h2o_data[[2]]
...
# P-value Stepwise Backward Elimination ----
